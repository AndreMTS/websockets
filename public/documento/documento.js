...
const listaUsuarioConectados = document.getElementById("usuarios-conectados")
...
function atualizarInterfaceUsuarios(usuariosNoDocumento){
  listaUsuarioConectados.innerHTML = ""

  usuariosNoDocumento.forEach(usuario => {
    listaUsuarioConectados.innerHTML += ` <li class="list-group-item">${usuario}</li>`;
  });
}
