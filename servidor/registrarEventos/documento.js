...
import { adicionarConexao, encontrarConexao, obterUsuarioDocumento, removerConexao } from "../utils/conexoesDocumentos.js";
...
function registrarEventosDocumento(socket, io) {
  socket.on("selecionar_documento",
    async ({ nomeDocumento, nomeUsuario }, devolverTexto) => {
      ...
      const conexaoEncontada = encontrarConexao(nomeDocumento, nomeUsuario)
